...
type ComplexityRoot struct {
	...
	Query struct {
		Heroes func(childComplexity int) int
		Types  func(childComplexity int) int
	}
}

type QueryResolver interface {
	Heroes(ctx context.Context) ([]model.Character, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.heroes":
		...
		return e.complexity.Query.Heroes(childComplexity), true
...
func (ec *executionContext) _Query_heroes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Heroes(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOCharacter2ᚕgithubᚗcomᚋpvormsteᚋtaskᚑgqlᚑfullᚑstackᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
	...
	for i, field := range fields {
		...
		case "heroes":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_heroes(ctx, field)
				return res
			})
		case "types":
			field := field
...
func (ec *executionContext) marshalOCharacter2githubᚗcomᚋpvormsteᚋtaskᚑgqlᚑfullᚑstackᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOCharacter2ᚕgithubᚗcomᚋpvormsteᚋtaskᚑgqlᚑfullᚑstackᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v []model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOCharacter2githubᚗcomᚋpvormsteᚋtaskᚑgqlᚑfullᚑstackᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
